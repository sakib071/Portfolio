...
const Profile = () => {
    ...
    return (
        <div className="Profile">
            <div className={`pt-20 p-5 lg:p-0 lg:pt-32 relative ${theme === 'dark' ? 'bg-zinc-900 text-white' : 'bg-white text-zinc-900'} font-semibold mx-auto`}>
                <div className="flex items-center gap-5">
                    ...
                    <div>
                        ...
                        <p className={`text-lg ${theme === 'dark' ? 'text-yellow-400' : ' text-zinc-500'} space-grotesk-400`}>Front-End Developer</p>
                    </div>
                </div>
                <p className="mt-5 text-base text-justify space-grotesk-400">As a front-end developer with a passion for building intuitive and dynamic web applications, I specialize in modern frameworks like <span className="text-yellow-400 space-grotesk-500-italic">React</span> and <span className="text-yellow-400 space-grotesk-500-italic">Tailwind CSS</span> to craft seamless, user-friendly experiences. With a deep understanding of design tools like <span className="text-yellow-400 space-grotesk-500-italic">Figma</span> and <span className="text-yellow-400 space-grotesk-500-italic">Adobe XD</span>, alongside development technologies such as <span className="text-yellow-400 space-grotesk-500-italic">Vite, JavaScript, and Git,</span> I’m committed to optimizing workflows and delivering visually compelling, responsive solutions. <br /> <br /> My skills in problem-solving, attention to detail, and project planning help me deliver efficient, high-quality results in collaborative environments.</p>
