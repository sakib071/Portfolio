...
const Navbar = () => {
    ...
    const navOptions = <>
        <li>
            <Link
                ...
                activeClass="active"
                className="text-black hover:text-green-500 transition-colors text-base space-grotesk-400 cursor-pointer"
            >
                Home
            </Link>
        </li>
    ...
    return (
        <div className="flex justify-center space-grotesk-400">
            <div className={`navbar max-w-3xl bg-white min-h-[12px] fixed w-full mx-auto lg:px-5 lg:top-5 lg:rounded-full border z-20 `}>
