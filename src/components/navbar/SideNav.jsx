...
const Navbar = () => {
    ...
    // Navbar link options with tracing effect
            ...
            <div className={`navbar lg:h-screen ${theme === 'dark' ? 'bg-zinc-900 text-white' : 'bg-white text-zinc-900'} min-h-[12px] top-0 left-0 mx-auto`}>
                ...
                <div className="navbar-center hidden lg:flex flex-col mx-auto w-[450px] justify-between h-[800px] p-5 items-start gap-10 mt-10 z-50 fixed left-52">
                    <div className="flex flex-col gap-10">
                        <a href="/" className="flex flex-col text-lg">
                            <img className="h-24 w-24 rounded-full object-cover mb-5" src="/Sakib.jpg" alt="" />
                            ...
                            <p className={`text-base font-semibold mt-5 mb-10 ${theme === 'dark' ? ' text-zinc-300' : 'text-zinc-500 hover:text-zinc-800'} space-grotesk-500`}>I bring digital designs to life, pixel by pixel.</p>
                        </a>
